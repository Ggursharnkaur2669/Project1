            ...
            <div class="row">
                <div class="col-md-6 products-grid-left">
                    <div class="products-grid-lft">
                        <em>
                            <h1 style="text-align:center; color:brown;font-style:italic;font-family: Times;padding-left:80%;font-size: 6em;">Library</h1>
                        </em><br><br>
                        <?php
						...
						$_SESSION['id'] = 'ID';
						$_SESSION['bTitle'] = 'Title';
						$_SESSION['bAuthor'] = 'Author';
						$_SESSION['bDesc'] = 'Description';
